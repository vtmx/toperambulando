...
## 23/03/2019
[x] Quanto ao resumo, 10 linhas
[x] Qto ao ao tamanho do titulo e subtítulo pode deixar livre. Veja o exemplo em https://www.terraadentro.com/. Assim posso ir ajuntando, até mesmo retirando os subtítulo.
[x] No rodapé bota só 3 colunas
2) Tentei instalar um plugin do instagram que tava bem recomendado (deixei até instalado), Aparentemente ele fez a conexão legal, mais não esta mostrando as fotos, se puder dar uma olhada ou se conhecer outro plugin bom.
[x] Você conhece algum plugin que mostra os posts recentes (ou populares) onde é mostrado além do texto uma thumbnail no widget? Veja no widget desse site https://pegadasnaestrada.com.br/
[x] Podemos tirar a categoria, não acho que seja relevante, deixar somente a data

Nos Posts
[x] Tem como colocar o Titulo do widgets com um fundo de outra cor para destacar 
2) O problema dos novos layouts das fotos

No celular
1) Não aparece o "leia mais"
2) o Rodapé esta desconfigurado
3) O contador de paginas de posts
